...
**MediWeb** is a full-featured, modern SaaS platform designed specifically for doctors, clinics, and healthcare professionals to create, customize, and publish stunning, responsive medical websites in minutes without any coding.
...
├── src/
│   ├── app/
│   │   ├── api/            # REST API endpoints (websites, services, appointments, auth)
...
│   ├── components/
│   │   └── renderer/       # Dynamic website rendering engine & icon helpers
