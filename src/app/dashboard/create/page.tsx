  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col">
      ...
      <header className="bg-white border-b border-slate-200 px-4 sm:px-6 h-16 flex items-center justify-between z-30 sticky top-0">
        ...
        <div className="flex items-center space-x-3">
          ...
          >
            ...
            <span>{isSubmitting ? "Creating..." : "Create Website"}</span>
          </button>
        </div>
      </header>
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 overflow-hidden">
            ...
            {currentStep === 6 && (
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Your website configuration is complete and ready to deploy.
                  </p>
                </div>
                ...
                >
                  ...
                  <span>{isSubmitting ? "Creating Website..." : "CREATE WEBSITE NOW"}</span>
                </button>
              </div>
            )}
          </div>
        ...
        {/* RIGHT COLUMN: LIVE WEBSITE PREVIEW (7 cols on lg) */}
        <div className="lg:col-span-7 bg-slate-200/80 p-4 sm:p-6 flex flex-col items-center justify-start overflow-y-auto h-[calc(100vh-110px)]">
          <div className="w-full flex items-center justify-between mb-3 text-xs text-slate-500">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-slate-700">Interactive Live Preview</span>
            </div>
